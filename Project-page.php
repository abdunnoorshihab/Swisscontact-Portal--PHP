...
<body class="font-sans">
    ...
    <div class="flex flex-wrap mt-5">
        <!-- Left Column -->
     <div class="w-full md:w-3/4 md:pr-5">
     ...
     <!-- External Press Release -->
            ...
            <section id="forms"
                class="mb-8 flex flex-col md:flex-row gap-4 md:gap-20 bg-white p-4 shadow sm:rounded-lg">
                <!-- Search Bar -->
                <div class="mb-4 w-full">
                    <div class="max-w-full mx-auto">
                        <div class="overflow-x-hidden">
                                ...
                                <table class="w-full text-sm text-left text-gray-500">
                                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-20 py-3">File Name</th>
                                            <th scope="col" class="px-0 py-3">Download</th>
                                        </tr>
                                    </thead>
                                    <tr
                                        class="bg-white border-b dark:bg-white-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-200">
                                        <th scope="row"
                                            ...
                                            <a href="#">
                                                <svg width="20px" height="20px" viewBox="0 0 32 32"
                                                    ...
                                                    <g id="SVGRepo_iconCarrier">
                                                        <defs>
                                                            <linearGradient id="a" x1="4.494" y1="-1712.086" x2="13.832"
                                                        ...
                                                        <path
                                                            ...
                                                            style="fill:#41a5ee"></path>
                                                        <path d="M30,9.5H8.512V16l11.069,1.95L30,16Z"
                                                            style="fill:#2b7cd3"></path>
                                                        <path d="M8.512,16v6.5L18.93,23.8,30,22.5V16Z"
                                                            style="fill:#185abd"></path>
                                                        <path
                                                            d="M9.705,29h19.1A1.192,1.192,0,0,0,30,27.809h0V22.5H8.512v5.309A1.192,1.192,0,0,0,9.705,29Z"
                                                            style="fill:#103f91"></path>
                                                        <path
                                        ...
                                        <td class="px-20 py-4"><a href="#">Form 1</a></td>
                                        <td class="px-6 py-4"><a href="#"><svg width="20px" height="20px"
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <a href="#">
                                                <svg version="1.1" id="_x35_" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    xml:space="preserve" width="18px" height="18px" fill="#000000">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
                                                        <g>
                                                            ...
                                                            <rect x="36.565" y="34.295" style="fill:#F2F2F2;"
                                                                width="205.097" height="91.768">
                                                            </rect>
                                                            <g>
                                                                <g>
                                        ...
                                        <td class="px-20 py-4"><a href="#">Form 2</a></td>
                                        <td class="px-6 py-4">
                                            <a href="#"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                            <a href="#"><svg width="20px" height="20px" viewBox="0 0 32 32"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                        ...
                                        <td class="px-20 py-4"><a href="#">Form 3</a></td>
                                        <td class="px-6 py-4">
                                            <a href="#"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                            <a href="#"><svg height="20px" width="20px" version="1.1" id="Capa_1"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 56 56"
                                                    ...
                                                    <g id="SVGRepo_iconCarrier">
                                                        <g>
                                                            ...
                                                            <polygon style="fill:#D9D7CA;"
                                                                points="37.5,0.151 37.5,12 49.349,12 "></polygon>
                                                            <g>
                                                            ...
                                                            <circle style="fill:#F3D55B;" cx="18.931" cy="14.431"
                                                                r="4.569"></circle>
                                                            <polygon style="fill:#88C057;"
                                        ...
                                        <td class="px-20 py-4"><a href="#">Form 4</a></td>
                                        <td class="px-6 py-4">
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                            <a href="#"><svg width="20px" height="20px" viewBox="0 0 32 32" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                        ...
                                        <td class="px-20 py-4"><a href="#">Form 5</a></td>
                                        <td class="px-6 py-4">
                                            <a href="#">
                                                <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button type="button"
                                class="py-2.5 px-5 w-full text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-blue-100 hover:text-blue-700 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-white-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-blue-500">
                                <a href="forms.html">Show all Resources</a>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full md:w-1/4 mt-5 md:mt-0">
            <!-- About Me Card -->
            <div class="card bg-white p-5 mb-5 shadow">
                <h2 class="text-xl font-semibold">About</h2>
                <div
                    class="fakeimg h-24 flex items-center justify-center text-white font-semibold mb-4 overflow-hidden bg-white">
                    <img src="img/astha.png" alt="Astha" class="w-full h-full object-contain">
                </div>
            ...
            <!-- team lead -->
            <div class="card bg-white p-5 mb-5 shadow">
                    <div class="max-w-xs bg-white rounded-xl p-4 shadow-lg">
                        <div class="flex gap-4">
                        <div class="h-28 w-28 rounded-lg">
                            <img src="img/random.jpg" alt="" srcset="">
                        </div>
                        <div class="flex flex-col justify-between flex-1 h-28">
                            <div>
