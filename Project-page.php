...
<body class="font-sans">
    ...
    <!-- Main Content -->
     ...
     <div class="w-full w-full md:pr-5">
        
    <!-- About Card -->
        <div class="card bg-white md:w-3/4 p-5 mb-5 shadow">
    ...
    <!-- team lead -->
        <div class="card bg-white p-5 mb-5 shadow">
                    <div class="max-w-xs bg-white md:w-1/4 rounded-xl p-4 shadow-lg">
    ...
    <!-- Right Column -->
        <div class="w-full w-full mt-5 md:mt-0">
