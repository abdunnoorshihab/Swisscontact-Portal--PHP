...
<head>
    ...
    <title>Responsive Card Slider with Swiper</title>
    ...
    <div class="container mx-auto p-4">
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <!-- Card 1 -->
                <div class="swiper-slide bg-white rounded-lg shadow-lg overflow-hidden w-64 h-30">
                    <a href="#guidelines" class="bg-white p-2 rounded-lg shadow hover:shadow-lg transition h-full flex flex-col justify-between">
            ...
            <div class="swiper-button-next text-black bg-white rounded-full p-3"></div>
            <div class="swiper-button-prev text-black bg-white rounded-full p-3"></div>
