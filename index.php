    ...
    <main class="container mx-auto px-6 py-8">
      ...
      <section class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-8 gap-6 ">
          <!-- Quick Link Card -->
          <a href="#guidelines" class="bg-white p-4 rounded-lg shadow hover:shadow-lg transition ">
            <div class="text-blue-500 justify-items-center">
              <!-- Icon Placeholder -->
              <svg version="1.1" id="layer" xmlns="http://www.w3.org/2000/svg"
                ...
                <path class="st0"
                  d="M37.6,377.4c-7-1.7-15.7-3.6-15.7-12.7c0-8,6.8-13,16.9-13c8.4,0,17.3,4,18.8,14.3l-8,1c-0.1-2.7-0.3-4.8-3.2-7
          ...
          <a href="#requisition" class="bg-white pt-8 rounded-lg shadow hover:shadow-lg transition  ">
            <div class="text-blue-500 mb-4 justify-items-center h-20 w-full h-20 w-full">
              <!-- Icon Placeholder -->
          ...
          <a href="#staff" class="bg-white pt-8 rounded-lg shadow hover:shadow-lg transition">
            <div class="text-blue-500 mb-4 justify-items-center h-20 w-full h-20 w-full">
              <!-- Icon Placeholder -->
          ...
          <a href="#tutorials" class="bg-white pt-8 rounded-lg shadow hover:shadow-lg transition">
            <div class="text-blue-500 mb-4 justify-items-center h-20 w-full">
              <!-- Icon Placeholder -->
          ...
          <a href="#tutorials" class="bg-white pt-5 rounded-lg shadow hover:shadow-lg transition ">
            <div class="text-blue-500 mb-4 justify-items-center h-20 w-full">
              <!-- Icon Placeholder -->
          ...
          <a href="#tutorials" class="bg-white pt-8 rounded-lg shadow hover:shadow-lg transition">
            <div class="text-blue-500 mb-4 justify-items-center h-20 w-full">
              <!-- Icon Placeholder -->
              <svg fill="#000000" width="64px" height="64px" viewBox="0 -1.41 122.88 122.88" id="Layer_1"
            ...
            <h3 class="text-xs text-center">Guest Register</h3>
          </a>
      ...
      <section id="tutorials" class="mb-8 w-full">
        ...
        <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
          ...
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
              <a href="IT-Tutorials/card1.php">
                <a href="IT-Tutorials/card1.php" class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">How to Use the
                  New VPN
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
                  acquisitions of 2021 so far, in reverse chronological order.</p>
                <a href="IT-Tutorials/card1.php"
                  class="inline-flex items-center px-3 py-2 text-sm font-medium  text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-200 dark:hover:bg-blue-700 dark:focus:ring-blue-800 gap-2">
                  Read more
          ...
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
              <a href="IT-Tutorials/card2.php">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Basic Troubleshooting
                  Guide</h5>
              </a>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
                acquisitions of 2021 so far, in reverse chronological order.</p>
          ...
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="IT-Tutorials/card3.php">
              <img class="rounded-t-lg h-48 w-full" src="img/setting-up-emails-picture.jpg" alt="" />
            </a>
            <div class="p-5">
              <a href="IT-Tutorials/card3.php">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Setting Up Email on
                  Mobile Devices</h5>
              </a>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
                acquisitions of 2021 so far, in reverse chronological order.</p>
